      ...
      <div className="min-h-screen  font-sans">
        ...
        <div className="bg-muted/50">
          <div className="container mx-auto px-4 pt-20 text-center">
            ...
            >
              Download <br />
              <span className="text-primary">Instafel</span>
            </motion.h1>
            <motion.p
            ...
            >
              You can download the APK files that suits you by selecting it from
              here!
            </motion.p>
        ...
        >
          <div className="container mx-auto px-4 mt-12 pb-12">
            ...
            >
                          ...
                          <CardContent className="p-6">
                            ...
                            <ul className="mt-4 space-y-2">
                              <li className="flex items-center gap-2">
                                ...
                                Requires Instagram to be deleted to install
                              </li>
                              <li className="flex items-center gap-2">
                                <ArrowRight className="h-4 w-4 text-primary" />
                        ...
                        <Card>
                          <CardContent className="p-6">
                            ...
                            <ul className="mt-4 space-y-2">
                              <li className="flex items-center gap-2">
                                <ArrowRight className="h-4 w-4 text-primary" />
                                Instagram does not need to be deleted to install{' '}
                              </li>
                              <li className="flex items-center gap-2">
                                <ArrowRight className="h-4 w-4 text-primary" />
                                Installed as different app
                              </li>
                              <li className="flex items-center gap-2">
                                <ArrowRight className="h-4 w-4 text-primary" />
              ...
              <TabsContent value="changelog" className="mt-0 animate-fade-in">
                <Card>
                  <CardContent className="p-6">
                    <h2 className="mb-4 flex items-center gap-2 text-2xl font-bold">
                    ...
                    <div className="space-y-8">
                      <div>
                        <div className="mb-2 flex items-center gap-2">
                          <Badge> v{data ? data.app.ifl_version : '...'}</Badge>
