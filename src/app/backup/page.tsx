              ...
              <CardContent className="">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">{data.manifest.description}</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground">
                      Version
                    </h3>
                    <p className="font-medium">{data.manifest.version_name}</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground">
                      Last Update
                    </h3>
                    <p className="font-medium">{data.manifest.last_updated}</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground">
                      Changelog
